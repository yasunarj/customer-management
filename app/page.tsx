    ...
    <>
      ...
      >
        <div className="absolute top-16 left-6 sm:top-16 sm:left-10 md:top-20 md:left-20 flex flex-col space-y-4 sm:space-y-6 md:space-y-8 items-star w-[80%]">
          <h2 className="text-gray-400 text-2xl sm:text-4xl md:text-5xl font-bold">
            地域No1のお店を作り
          </h2>
          <h3 className="text-gray-400 text-2xl sm:text-3xl md:text-4xl font-semibold ml-8 sm:ml-16 md:ml-24">
            お客様には最高の満足を
          </h3>
        </div>
